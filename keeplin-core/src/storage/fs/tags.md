# `storage/fs/tags.rs` — tag and note-tag association storage

Self-contained companion for `keeplin-core/src/storage/fs/tags.rs`. It documents every source block in source order with complete code embedded for every leaf.
...
**What it does** — Owns tag and note-tag association storage. This is a structural relocation from the former monolithic filesystem module; storage behavior, on-disk format version 8, serialization shapes, conflict resolution, and public API are unchanged.
...
**Code** — container: members documented as sub-blocks below: fn tag_path, fn note_tag_dir, fn note_tag_path, fn read_assoc_state, fn next_assoc_vv, fn assoc_incoming_wins, fn write_assoc_state.
...
- `tag and note-tag association storage` — defined here (INFERRED)
...
| 2 | `NoteTagState` | `// md:NoteTagState` |
| 3 | `impl FsBackend` (container) | `// md:impl FsBackend` |
| 4 | `fn tag_path` | `// md:impl FsBackend > fn tag_path` |
| 5 | `fn note_tag_dir` | `// md:impl FsBackend > fn note_tag_dir` |
| 6 | `fn note_tag_path` | `// md:impl FsBackend > fn note_tag_path` |
| 7 | `fn read_assoc_state` | `// md:impl FsBackend > fn read_assoc_state` |
| 8 | `fn next_assoc_vv` | `// md:impl FsBackend > fn next_assoc_vv` |
| 9 | `fn assoc_incoming_wins` | `// md:impl FsBackend > fn assoc_incoming_wins` |
| 10 | `fn write_assoc_state` | `// md:impl FsBackend > fn write_assoc_state` |
| 11 | `impl TagRepository for FsBackend` (container) | `// md:impl TagRepository for FsBackend` |
| 12 | `fn create_tag` | `// md:impl TagRepository for FsBackend > fn create_tag` |
| 13 | `fn read_tag` | `// md:impl TagRepository for FsBackend > fn read_tag` |
| 14 | `fn update_tag` | `// md:impl TagRepository for FsBackend > fn update_tag` |
| 15 | `fn delete_tag` | `// md:impl TagRepository for FsBackend > fn delete_tag` |
| 16 | `fn list_tags` | `// md:impl TagRepository for FsBackend > fn list_tags` |
| 17 | `fn add_note_tag` | `// md:impl TagRepository for FsBackend > fn add_note_tag` |
| 18 | `fn remove_note_tag` | `// md:impl TagRepository for FsBackend > fn remove_note_tag` |
| 19 | `fn list_note_tags` | `// md:impl TagRepository for FsBackend > fn list_note_tags` |
