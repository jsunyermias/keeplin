...
| [0008 — Trusted evaluator, verified disposal, and a bounded history claim](0008-trusted-evaluator-verified-disposal-and-a-bounded-history-claim.md) | accepted; authenticity claim proposed to be superseded by 0011 | cross-repo | Supersedes 0006 and 0007. Delivers the trusted evaluator and verified disposal, and states plainly that terminal history deletion is not detected; [0011](0011-bounded-journal-authenticity.md) proposes a narrower authenticity claim while leaving that truncation bound standing |
| [0009 — Review governance is evaluated from the default branch](0009-governance-evaluated-from-the-default-branch.md) | accepted; proposed to be superseded completely by 0012 | cross-repo | Extends 0008 and addresses F-025. Accepted and unimplemented; [0012](0012-default-branch-review-governance.md) preserves the decision while completing its required risk, compatibility, migration, verification, and rollback analysis and resolving the `ci.yml` contradiction |
| [0011 — Bound the review journal's authenticity claim](0011-bounded-journal-authenticity.md) | proposed | cross-repo | Would supersede 0008 on authenticity only: the unkeyed chain detects accidental corruption and casual editing, not forgery by another repository workflow carrying the same App identity. Leaves 0008's terminal-truncation bound standing |
| [0012 — Evaluate review governance from the default branch](0012-default-branch-review-governance.md) | proposed | cross-repo | Would supersede 0009 completely. Keeps the `ci.yml` governance step as a nonauthoritative fast signal and makes default-branch evaluation authoritative, while preserving the bound that head-authored evidence remains unauthenticated |
